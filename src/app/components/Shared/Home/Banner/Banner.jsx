  ...
  const onAutoplayTimeLeft = (s, time, progress) => {
    ...
    return (
      ...
      >
        ...
        <SwiperSlide>
        <div className='grid grid-cols-2 lg:h-[500px] md:h-[400px] h-[300px] bg-red-200 px-2 lg:px-44  md:px-20'>
        <div>
                 <div className='text-right pt-20'>
                    <h1 className='text-sm lg:text-xl md:text-xl  pb-3 font-semibold'>NEW ARRIVAL</h1>
                    <h1 className='text-sm md:text-3xl lg:text-5xl pb-3   font-semibold '>FOR HER</h1>
                    <h1 className=' text-[27px] md:text-[35px] lg:text-[55px] pb-8 font-bold  relative '>SUNGLASS </h1>
                    <button className='px-8 lg:px-32 md:px-20 py-2 lg:py-4 md:py-3 bg-green-600 text-white rounded-sm font-semibold text-white'>Shop now</button>
                 </div>
               </div>
